...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(
     ...
     KC_GRV     ,KC_LGUI    ,KC_LPRN    ,KC_RPRN    ,            KC_BSPC    ,TGL_DEV    ,TGL_MOUSE  ,KC_TAB     ,            KC_LBRC    ,KC_LBRC    ,KC_RBRC    ,KC_RGHT    
     // @kbd-prettier:end
  ),
  ...
  _______,KC_7   ,KC_8   ,KC_9   ,_______,_______,_______,_______,_______,KC_1   ,KC_2   ,KC_3   ,_______,_______,
  _______,_______,_______,_______,        _______,_______,_______,_______,        _______,_______,_______,_______
  // @kbd-prettier:end
  ),
  [_MOUSE] = LAYOUT(
  ...
  _______ ,KC_F1   ,KC_F2   ,KC_F3   ,KC_F4   ,KC_F5   ,_______ ,_______ ,_______ ,KC_LEFT ,KC_DOWN ,KC_UP   ,KC_RIGHT,_______ ,
